...
@Component({
  selector: 'app-popularplan-display',
  templateUrl: './popularplan-display.component.html',
  styleUrls: ['./popularplan-display.component.css']
})
export class PopularplanDisplayComponent implements OnInit {
  popup = true;
  addForm!: FormGroup;
   response:any;
  
  constructor(private api:PopularService,private route:Router) { }
